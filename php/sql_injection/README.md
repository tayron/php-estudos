...
3) Utilizando objeto PDO para executar as querys no banco. Usamos o bindParam para atribuir as variáveis ao resto da query, se alguma irregularidade existir o MySQL não executará a query:
